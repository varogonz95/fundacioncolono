...
<head>
    ...
    <script src="{{asset('app/controllers/PersonaController.js')}}"></script>
    <script src="{{asset('app/controllers/ExpedienteController.js')}}"></script>
...
<body class="container-fluid">
    ...
    <main class="row" ng-app="App" ng-controller="Main">
        ...
        <section id="main" class="col-sm-8 col-md-10 col-md-push-2">
            <div id="viewplaceholder" class="container-fluid" ng-view></div>
        </section>
